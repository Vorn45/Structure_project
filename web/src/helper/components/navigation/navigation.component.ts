...
import { HelperNavigationAsideItemComponent } from 'helper/components/navigation/components/aside/aside.component';
...
import { HelperScrollbarDirective } from 'helper/directives/scrollbar';
...
@Component({
    ...
    imports: [
        ...
        HelperNavigationAsideItemComponent,
    ...
    implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    ngAfterViewInit(): void {
        ...
        // 'marginTop' to the navigation itself. Chrome/Safari don't have this sticky-in-fixed quirk,
        // so this must stay Firefox-only — otherwise any scroll-blocking overlay (e.g. the
        // notification/group-chat panels) leaves a stray margin-top on the nav in those browsers,
        // pushing it down and making it fall short of full viewport height.
     ...
     */
    ngOnDestroy(): void {
        // Disconnect the mutation observer (only ever created on Firefox — see ngAfterViewInit)
