...
export class ThinHeaderLayoutComponent implements OnInit, OnDestroy {
    ...
    /** Personal workspace pages build their own header row (home icon, title,
     *  search, chat/notification/avatar) — this bar would just duplicate it. */
