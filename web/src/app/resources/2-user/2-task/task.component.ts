    ...
    kanbanColumns = [
        {
            ...
            panelBg: 'bg-blue-50/70 dark:bg-blue-950/25',
            panelBorder: 'border-blue-200/80 dark:border-blue-900/50',
            emptyBorder: 'border-blue-300/70 text-blue-600 dark:border-blue-800/60 dark:text-blue-400 hover:bg-blue-100/50 dark:hover:bg-blue-900/30',
            cardBorder: 'border-l-[3.5px] border-l-blue-500',
            badgeClass: 'bg-blue-100/80 text-blue-700 dark:bg-blue-900/60 dark:text-blue-300 border border-blue-200/80 dark:border-blue-800/60',
        },
        {
            key: 'confirmed',
            label: 'បញ្ជាក់',
            ...
            panelBg: 'bg-indigo-50/70 dark:bg-indigo-950/25',
            panelBorder: 'border-indigo-200/80 dark:border-indigo-900/50',
            emptyBorder: 'border-indigo-300/70 text-indigo-600 dark:border-indigo-800/60 dark:text-indigo-400 hover:bg-indigo-100/50 dark:hover:bg-indigo-900/30',
            cardBorder: 'border-l-[3.5px] border-l-indigo-500',
            badgeClass: 'bg-indigo-100/80 text-indigo-700 dark:bg-indigo-900/60 dark:text-indigo-300 border border-indigo-200/80 dark:border-indigo-800/60',
        },
        {
            key: 'unconfirmed',
            label: 'មិនបញ្ជាក់',
            ...
            panelBg: 'bg-slate-100/75 dark:bg-slate-900/40',
            panelBorder: 'border-slate-200/90 dark:border-slate-800',
            emptyBorder: 'border-slate-300/80 text-slate-600 dark:border-slate-700/70 dark:text-slate-400 hover:bg-slate-200/50 dark:hover:bg-slate-800/40',
            cardBorder: 'border-l-[3.5px] border-l-slate-400',
            badgeClass: 'bg-slate-200/80 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border border-slate-300/70 dark:border-slate-700/60',
        },
        {
            key: 'in_progress',
            label: 'កំពុងធ្វើ',
            ...
            panelBg: 'bg-amber-50/70 dark:bg-amber-950/25',
            panelBorder: 'border-amber-200/80 dark:border-amber-900/50',
            emptyBorder: 'border-amber-300/70 text-amber-600 dark:border-amber-800/60 dark:text-amber-400 hover:bg-amber-100/50 dark:hover:bg-amber-900/30',
            cardBorder: 'border-l-[3.5px] border-l-amber-500',
            badgeClass: 'bg-amber-100/80 text-amber-800 dark:bg-amber-900/60 dark:text-amber-300 border border-amber-200/80 dark:border-amber-800/60',
        },
        {
            key: 'in_review',
            label: 'ស្នើពិនិត្យ',
            ...
            barColor: 'bg-sky-500',
            panelBg: 'bg-sky-50/70 dark:bg-sky-950/25',
            panelBorder: 'border-sky-200/80 dark:border-sky-900/50',
            emptyBorder: 'border-sky-300/70 text-sky-600 dark:border-sky-800/60 dark:text-sky-400 hover:bg-sky-100/50 dark:hover:bg-sky-900/30',
            cardBorder: 'border-l-[3.5px] border-l-sky-500',
            badgeClass: 'bg-sky-100/80 text-sky-800 dark:bg-sky-900/60 dark:text-sky-300 border border-sky-200/80 dark:border-sky-800/60',
        },
        {
            key: 'reopened',
            label: 'បើកឡើងវិញ',
            ...
            panelBg: 'bg-rose-50/70 dark:bg-rose-950/25',
            panelBorder: 'border-rose-200/80 dark:border-rose-900/50',
            emptyBorder: 'border-rose-300/70 text-rose-600 dark:border-rose-800/60 dark:text-rose-400 hover:bg-rose-100/50 dark:hover:bg-rose-900/30',
            cardBorder: 'border-l-[3.5px] border-l-rose-500',
            badgeClass: 'bg-rose-100/80 text-rose-700 dark:bg-rose-900/60 dark:text-rose-300 border border-rose-200/80 dark:border-rose-800/60',
        },
        {
            key: 'done',
            label: 'បញ្ចប់',
            ...
            panelBg: 'bg-emerald-50/70 dark:bg-emerald-950/25',
            panelBorder: 'border-emerald-200/80 dark:border-emerald-900/50',
            emptyBorder: 'border-emerald-300/70 text-emerald-600 dark:border-emerald-800/60 dark:text-emerald-400 hover:bg-emerald-100/50 dark:hover:bg-emerald-900/30',
            cardBorder: 'border-l-[3.5px] border-l-emerald-500',
            badgeClass: 'bg-emerald-100/80 text-emerald-800 dark:bg-emerald-900/60 dark:text-emerald-300 border border-emerald-200/80 dark:border-emerald-800/60',
        },
    ];
    ...
    projects = signal<ProjectFilterOption[]>([
        {
            ...
            code: 'BMS',
            logo: 'images/logo/camcybermail.png',
            bgClass: 'bg-white',
        },
        {
            id: 'wms-digitech',
        ...
        },
        {
            ...
            code: 'NT',
            logo: 'images/logo/nextask-logo.png',
