...
@Component({
    ...
    template: `
        <div class="w-full h-full flex flex-col bg-white dark:bg-slate-900 font-kantumruy text-[15px] font-normal relative overflow-visible" style="font-family: 'Kantumruy Pro', sans-serif;">
